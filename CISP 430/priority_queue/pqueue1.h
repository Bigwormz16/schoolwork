...
//  STUDENT ID: W1387836
//  Assignment 4
// Purpose: PriorityQueue class header file - queue based on priority, items stored
//			within a linked list using a basic Node struct, defined within this file.
/* Comments: pqueue1.h has not been modified from its original specification as
			 provided by Professor Huang. Implementation located in pqueue1.cpp		*/
