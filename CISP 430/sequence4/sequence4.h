...
//  STUDENT ID: W1387836
//  Assignment 3
/* Purpose: Sequence class header file - linked list implementation of sequence using node class. */
/* Comments: sequence4.h has not been modified from its original specification as
			 provided by Professor Huang. Implementation located in sequence4.template -- see notes there. */
