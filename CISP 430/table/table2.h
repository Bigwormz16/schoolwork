...
//  Notes: table::TABLE_SIZE changed from 811 to 10 to accomodate test program.
//         clear() function added -- clears entire table
//         uses link2.h -- functionality and implementation have not been changed.
/*--------------------------------------------------------------------------------*/
...
#include "link2.h"    // Provides the node type, from Figure 6.5 on page 306
